...
def getJetCorrected(era, tag, is_mc, overwritePt=True) :
    ...
    if era == 2022:
        ...
        if is_mc :
                ...
                L1Key = "Winter24Prompt24_V3_MC_L1FastJet_AK4PFPuppi"
                L2Key = "Winter24Prompt24_V3_MC_L2Relative_AK4PFPuppi"
                L3Key = "Winter24Prompt24_V3_MC_L3Absolute_AK4PFPuppi"
                L2L3Key = "Winter24Prompt24_V3_MC_L2L3Residual_AK4PFPuppi"
                scaleTotalKey = "Winter24Prompt24_V3_MC_Total_AK4PFPuppi"
                smearKey = "JERSmear"
                JERKey = "Summer23BPixPrompt23_RunD_JRV1_MC_PtResolution_AK4PFPuppi"
                JERsfKey = "Summer23BPixPrompt23_RunD_JRV1_MC_ScaleFactor_AK4PFPuppi"
        else :
    ...
    usePhiDependentJEC = (era > 2023 or (era == 2023 and "BPix" in tag)) # False up to 2023 pre_BPix, True in 2023 post_BPix and afterwards
